...
Route::middleware('web')->prefix('v1')->group(function () {
    ...
    Route::middleware('auth')->prefix('account')->group(function () {
        ...
        Route::get('/resources', [AccountController::class, 'resources']);
        ...
        Route::post('/claim-purchases', [AccountController::class, 'claimPurchases']);
        Route::post('/claim-purchase', [AccountController::class, 'claimPurchase']);
    ...
    Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
        ...
        Route::post('/orders/{order}/approve-payment', [AdminController::class, 'approveOrderPayment']);
        ...
        Route::get('/customers/{user}/access', [AdminController::class, 'customerAccess'])->whereNumber('user');
        Route::post('/customers/{user}/access/products', [AdminController::class, 'grantProductAccess'])->whereNumber('user');
        Route::post('/customers/{user}/access/resources', [AdminController::class, 'grantResourceAccess'])->whereNumber('user');
        Route::post('/access/product-entitlements/{entitlement}/revoke', [AdminController::class, 'revokeProductAccess']);
        Route::post('/access/resource-grants/{grant}/revoke', [AdminController::class, 'revokeResourceAccess']);
